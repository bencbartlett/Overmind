...
// 			this.walkableControllerPosisions =
// 				_.filter(this.room.controller!.pos.neighbors, pos => pos.isWalkable(true));
// 		}
// 		if(this.room && this.room.controller
// 			&& this.room.controller.reservation && this.room.controller.reservation.ticksToEnd > 500){
