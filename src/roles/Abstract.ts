...
export class WrappedCreep implements Zerg {
	...
	// 	return this.pos.roomName == other.pos.roomName;
	// }
	...
	// 		return this.colony.overseer.objectiveGroup.objectivesByRef[this.memory.objectiveRef];
	// 	} else {
	// 		return null;
	// 	}
	// }
	...
	/* Default logic for requesting a new task from the colony overseer. Creeps which request tasks from
	 * other objects, such as hatchery/commancCenter/etc should overwrite this method. */
	// requestTask(): void {
	// 	return this.colony.overseer.assignTask(this);
	// }
