...
export var HUD = {
    ...
    //             let neededHaulers = Math.ceil(room.colony.calculateRemoteHaulingRequirements() / haulerCargoSize);
...
import profiler = require('../lib/screeps-profiler'); profiler.registerObject(HUD, 'HUD');
