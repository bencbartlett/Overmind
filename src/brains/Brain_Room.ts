...
export class RoomBrain {
    ...
    getMostUrgentTask(tasksToGet): [Task, RoomObject[]] {
    ...
    assignTask(creep): number {
        ...
        if (targets != null) { // TODO: is this null check necessary?
            ...
            if (task.name == 'fortify') {
                ...
                target = _.sortBy(targets, (target: StructureWall | StructureRampart) => target.hits)[0];
            } else {
